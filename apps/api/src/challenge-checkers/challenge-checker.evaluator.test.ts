...
const finds = [
  { foundAt: new Date("2025-01-01T00:00:00Z"), cache: { gcCode: "GC1", name: "One", cacheType: "Traditional Cache", difficulty: 1, terrain: 1, country: "Sweden", region: "Skane", county: null } },
  { foundAt: new Date("2025-01-01T00:00:00Z"), cache: { gcCode: "GC2", name: "Two", cacheType: "Mystery Cache", difficulty: 2.5, terrain: 3, country: "Sweden", region: "Skane", county: null } },
  { foundAt: new Date("2024-02-29T00:00:00Z"), cache: { gcCode: "GC3", name: "Three", cacheType: "Traditional Cache", difficulty: 1, terrain: 1, country: "Denmark", region: null, county: null } }
];
...
test("scopes duplicate county names through their selected parents", () => {
  const result = evaluateChallenge([
    ...
    ...finds,
    { foundAt: new Date("2025-03-01T00:00:00Z"), cache: { gcCode: "GC4", name: "Wrong parent", cacheType: "Traditional Cache", difficulty: 1, terrain: 1, country: "Denmark", region: "Zealand", county: "Central" } },
    { foundAt: new Date("2025-03-02T00:00:00Z"), cache: { gcCode: "GC5", name: "Right parent", cacheType: "Traditional Cache", difficulty: 1, terrain: 1, country: "Sweden", region: "Skane", county: "Central" } }
  ]);
